...
import top.mylady.media.kafka.AdminMessageSender;
import top.mylady.media.service.NewsService;
import top.mylady.model.common.dtos.PageResponseResult;
...
public class NewsServiceImpl implements NewsService {
    ...
    private ResponseResult saveRelationInfo(Map<String, Object> materials, Integer newsId, Short type) {
        ...
        if(dbMaterialInfos!=null && dbMaterialInfos.size() != 0){
            ...
            //存储关联
            wmNewsMaterialMapper.saveRelationByContent(materials,newsId,type);
        }
        return null;
    }
