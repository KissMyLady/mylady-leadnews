...
import top.mylady.model.mappers.wemedia.WmNewsMapper;
...
import top.mylady.model.user.pojos.ApUserMessage;
import top.mylady.utils.common.Compute;
...
public class ReviewMediaArticleServiceImpl implements ReviewMediaArticleService {
    ...
    private static final Logger logger = Logger.getLogger(ReviewMediaArticleServiceImpl.class);
    ...
    private void reviewSuccessSaveAll(WmNews wmNews) {
        ...
        if(wmNews.getUserId() != null){
            ...
            if(wmUser!=null && wmUser.getName() != null){
                ...
                if(apAuthor==null || apAuthor.getId() == null){
                    ...
                    apAuthorMapper.insertApAuthor(apAuthor);
                }
            }
        }
        ...
        apArticleConfigMapper.insertApArticleConfig(apArticleConfig);
