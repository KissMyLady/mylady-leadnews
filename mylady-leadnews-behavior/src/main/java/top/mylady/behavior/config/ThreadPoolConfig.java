package top.mylady.behavior.config;
...
public class ThreadPoolConfig {
    ...
    private static final String threadNamePrefix = "Behavior-myladyLeadnews-async"; // 线程池名前缀
    ...
    public ThreadPoolTaskExecutor taskExecutor(){
        ...
        // 初始化
        pool.initialize();
        logger.info("Behavior模块, 默认异步线程池完成, 交给Spring容器管理");
        return pool;
    }
}
