...
public class IdsUtils {
    ...
    * */
    public static void main(String[] args) throws Exception{
        ...
        String encryptStr = encryptNumber(nums);

        System.out.println("加密后的字符串: "+ encryptStr);  //B90CFD2221AD6AC54BCA39379B1C4F1E
        System.out.println("解密decrypt后的数字: "+ decryptInt(encryptStr));
    }
